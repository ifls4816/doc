...
class App extends React.Component {
  // render方法是子类组件从父类组件继承来的 render必须return
  render() {
    return (
      <div>
        App-------
...
```js
// 手机app的弹窗->多次出现->封装的产物->组件->模态框组件->Modal
...
class App extends React.Component {
  ...
  // 这里的e是高级事件对象,只能用e.preventDefault()阻止默认行为
  fn1 = e => {
    console.log('fn1-----')
    console.log(e)
  }
...
9. 目前希望bundle.js的代码是非压缩的,可以修改webpack配置,新增mode设置
